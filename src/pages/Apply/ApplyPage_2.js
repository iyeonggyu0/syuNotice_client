...
const ApplyPage2 = () => {
  ...
  // 전체
  const [receive, setReceive] = useState(localStorage.getItem("2-receive") === "false" ? false : true);
  ...
  const nextButton = (e) => {
    ...
    if (!receive) {
      ...
      localStorage.setItem("2-receive", receive);
      return nav("/apply/3");
    }
  };
          ...
          <div>
            <div
              onClick={() => {
                ...
                localStorage.setItem("2-receive", var_); // `localStorage` 업데이트
              }}>
